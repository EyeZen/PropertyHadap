...
function GameStatus() {
    ...
    const isWinner = (player) => gameOver && players.map(player => ({...player, score: scoreOf(player)})).reduce((playerPrev, playerCurr) => playerPrev.score > playerCurr ? playerPrev : playerCurr).alias === player.alias;
